...
class generate_iterator(strategy):
    def func(self, observer):
        ...
        self.list_.insert(k, *array_generate.iter_generate(n, a, b), event_observer=observer)
        return self.list_
...
class generate_generator(strategy):
    def func(self, observer):
        n, a, b, k = generate_input(len(self.list_))
        self.list_.insert(k, *array_generate.generator_generate(n, a, b), event_observer=observer)
        return self.list_
...
class from_file(strategy):
    def func(self, observer):
        ...
        self.list_.insert(k, *new_list, event_observer=observer)

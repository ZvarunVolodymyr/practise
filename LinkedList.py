...
class LinkedList:
    ...
    def execute_strategy(self, observer):
        return self.strategy.func(observer)
    ...
    def remove(self, pos1, pos2=None):
        if pos2 is None:
            pos2 = pos1 + 1
        pos1 = validation.is_int_in_range(pos1, 0, self.length - 1)
        pos2 = validation.is_int_in_range(pos2, pos1, self.length - 1)
